        ...
        <form action="" className={styles.form}>
            <section className={styles.section}>
                <div className={styles.titleWrapper}>
                    <img className={styles.icon} src="src/assets/contact.svg" alt="" />
            ...
            <section className={styles.section}>
                <div className={styles.titleWrapper}>
                    <img   className={styles.icon} src="src/assets/education.svg" alt="" />
            ...
            <section className={styles.section}>
                <div className={styles.titleWrapper}>
                    <img  className={styles.icon} src="src/assets/work.svg" alt="" />
